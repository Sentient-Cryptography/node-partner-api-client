...
var processRequest = function (partnerId, apiKey, apiURL, method, data) {
  return Q.Promise(function (resolve, reject) {
    ...
    if (partnerId) options.headers['X-Partner-ID'] = partnerId;
...
var netkiClient = function (apiKey, partnerID, apiURL) {
  ...
  this.walletLookupURL = 'https://pubapi.netki.com/api/wallet_lookup/';
};
...
netkiClient.prototype.lookupWalletName = function(walletName, currency) {
  return processRequest(null, null, this.walletLookupURL + walletName + '/' + currency, 'GET');
};
